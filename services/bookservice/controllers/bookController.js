...
const addNewBook = async (req, res) => {
    try {
        ...
        const { bookName, desc, bookCategories, bookStatus, bookAuthors, userId, imagePath } = req.body;
        ...
        //Step 3 -- Insertion
        const result = await executeInsertNewBook(bookName, desc, bookCategories, bookStatus,bookAuthors,userId,imagePath);
...
const updateABook = async (req,res) => {
    try{
        ...
        //Step 5 -- Edit the Id
        const result = await executeUpdateBook(id,bookName,desc,bookCategories,bookStatus,bookAuthors,imagePath);
        res.status(200).json({message: result});
    }
    catch(e){
        console.log(e);
